...
/// Barra de progreso compartida por los pasos del alta de animal.
class RegisterAnimalProgressIndicator extends StatelessWidget {
  /// Crea una barra de progreso para el paso actual del flujo.
  const RegisterAnimalProgressIndicator({
