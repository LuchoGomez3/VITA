...
class HomeStrings {
  ...
  /// Titulo del modulo de reporte SENASA.
  static const senasaReportTitle = 'Reporte de SENASA';

  /// Descripcion del modulo de reporte SENASA.
  static const senasaReportDescription =
      'Generacion offline de planillas de movimientos y existencias en formato '
      'TXT y CSV.';

  /// Boton para abrir el modulo de reporte SENASA.
  static const senasaReportButton = 'Ver reporte de SENASA';
}
